						...
						<div className="row align-items-center">
							...
							<div className="col-sm-8 col-4">
								<ul className="list-inline user-chat-nav text-right mb-0">
									...
									<li className="list-inline-item">
										<div className="dropdown">
											<button onClick={onSidebar} className="btn nav-btn dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
					...
					<div className="user-profile-sidebar">
						<div className="px-3 px-lg-4 pt-3 pt-lg-4">
							<div className="user-chat-nav text-right">
								<button onClick={onSidebar} type="button" className="btn nav-btn" id="user-profile-hide">
